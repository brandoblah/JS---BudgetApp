...
1. Add event handler to "click" (CONTROLLER MODULE)

2. Get input values (UI MODULE)

3. Add the new item to our data structure (DATA MODULE)

4. Add the new item to UI (UI MODULE)
